...
#include "sample_action_interface/action/fibonacci.hpp"

#include "rclcpp/rclcpp.hpp"
#include "rclcpp_action/rclcpp_action.hpp"
#include "rclcpp_components/register_node_macro.hpp"

namespace sample_action_cpp
{
class FibonacciActionClient : public rclcpp::Node
{
public:
  using Fibonacci = sample_action_interface::action::Fibonacci;
...
RCLCPP_COMPONENTS_REGISTER_NODE(sample_action_cpp::FibonacciActionClient)